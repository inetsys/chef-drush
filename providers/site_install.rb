...
action :install do
    if @current_resource.exists && !@new_resource.force
        ...
        converge_by("Create #{@new_resource}") do
            ...
            if new_resource.db_prefix.is_a?(Hash) && new_resource.db_prefix.has_key?('default')
                db_prefix = new_resource.db_prefix['default']
            elsif new_resource.db_prefix.is_a?(String)
